        ...
        <StyledScrollView style={{height:'82%', backgroundColor:"#fff"}}>
            ...
            <TouchableOpacity>
                <StyledView style={{flexDirection:'row',margin:20}}>
                    <PlusSvg/>
                    <StyledText style={{fontWeight:600,fontSize:20,marginLeft:5,color:"#FF8C03"}}>Add new card</StyledText>
                </StyledView>
            </TouchableOpacity>

            <StyledText style={{marginLeft:20,fontSize:20,fontWeight:600}}>Payment history</StyledText>
            {/* payments history */}
            <PaymentsHistory/>
